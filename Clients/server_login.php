<?php
    ...
    if(isset($_POST['login'])){
        ...
        $query = "Select Status, SupposedClientId from OnlineBankingApp where username = '$username' and passwordHash = '$password'";
    ...
    if(isset($_POST['login_from_teller'])){
       $nationalid = $_SESSION['nationalid'];
        
        $query = "Select Status,SupposedClientId from OnlineBankingApp where nationalid = '$nationalid'";
        $result = mysqli_query($db, $query);
